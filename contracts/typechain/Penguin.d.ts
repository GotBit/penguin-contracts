...
interface PenguinInterface extends ethers.utils.Interface {
  functions: {
...
export class Penguin extends BaseContract {
  ...
  callStatic: {
    ...
    revokeMinter(_minter: string, overrides?: CallOverrides): Promise<void>;
